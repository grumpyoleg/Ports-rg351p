...
class Settings:
    ...
    BAUDRATE = 115200
    DATA_DIR = '/home/pi/duino-coin_10x/settings_service_avr'
    SEPARATOR = ","
    ENCODING = "utf-8"
    BLOCK = " ‖ "
    PICK = ""
        ...
        while True:
            ...
            while True:
                ...
                try:
                    ...
                    avrsock.connect(('127.0.0.1', 8082))
                    ...
                    #ser.write(bytes(str(msg_send),encoding=Settings.ENCODING))
...
if __name__ == '__main__':
    ...
    try:
        ...
        threadid = 0
        nanos = 0
        for nanos in range(15):
            thrThread(target=mine_avr,
                      args=('/dev/serial1', threadid,
                            fastest_pool)).start()
            threadid += 1
        #for port in avrport:
        #    thrThread(target=mine_avr,
